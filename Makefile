...
OBJS = src/procinfo.o src/sudo_tracer.o src/su_tracer.o src/ssh_tracer.o src/kinit_tracer.o src/ssh_client_tracer.o src/tracers.o src/main.o src/plisten.o src/passwd_tracer.o
